...
// crescente (sirva pra ordenar e pra saber o que o usuário já viu — comparação
...
export const TIPO_LABEL = { novidade: "Novidade", melhoria: "Melhoria", correcao: "Correção", lancamento: "Lançamento" };
export const TIPO_TONE = { novidade: "green", melhoria: "amber", correcao: "red", lancamento: "gray" };
